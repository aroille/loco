...
namespace loco
{
	namespace entry
	{
		...
		int main(int _argc, char** _argv)
		{
			...
			entry::set_window_title(defaultWindow, bx::baseName(_argv[0]));
		...
		bool process_events(uint32_t& _width, uint32_t& _height, uint32_t& _debug, uint32_t& _reset, MouseState* _mouse)
		{
			s_debug = _debug;
			s_reset = _reset;
